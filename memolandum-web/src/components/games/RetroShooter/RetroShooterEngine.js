  ...
  draw(ctx) {
    ...
    if (this.isBoss) {
      ...
      if (this.word.romanized_script) {
        ...
        ctx.fillText(this.word.romanized_script, roundedX + roundedWidth / 2, roundedY + roundedHeight / 2 + 15);
      } else {
        ctx.font = 'bold 22px Arial, sans-serif';
        ctx.fillText(this.word.english, roundedX + roundedWidth / 2, roundedY + roundedHeight / 2 + 5);
      }
      ...
      if (lines.length > 1) {
        ...
        ctx.fillStyle = isRomanized ? (isPlayZone ? 'rgba(255, 255, 255, 0.7)' : 'rgba(255, 255, 255, 0.3)') : (isPlayZone ? '#ffffff' : 'rgba(255, 255, 255, 0.4)');
        ctx.font = isRomanized ? (isPlayZone ? 'bold 14px Arial, sans-serif' : '12px Arial, sans-serif') : (isPlayZone ? 'bold 18px Arial, sans-serif' : '16px Arial, sans-serif');
