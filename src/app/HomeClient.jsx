  ...
  return (
    <div className="min-h-screen bg-dark-900 text-gray-200 font-sans selection:bg-primary-500/30">
      ...
      <main className="relative pt-4 pb-16 px-6 max-w-6xl mx-auto min-h-screen flex flex-col justify-start">
            ...
            <a href="/about/" className="block mb-4 no-underline group cursor-pointer hover:opacity-95 transition-opacity">
                ...
                <div className="banner-content">
                  <div className="banner-text-side">
                    ...
                    <h2 className="banner-title">
                      {t("home.bannerTitleBefore")} <span className="highlight-text">{t("home.bannerTitleHighlight")}</span>
                    </h2>
